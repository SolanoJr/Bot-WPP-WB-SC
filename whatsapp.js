...
const whatsappSingleton = require('./dist/services/whatsappSingleton');
const { isMaster } = require('./dist/services/permissions');
const { processMessage } = require('./dist/services/messageHandler');
